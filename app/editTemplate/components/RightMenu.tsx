  ...
  return (
    <>
      <div className={`fixed h-full top-0 z-10 pt-10 transition-all ${!isMenuOpen ? '-right-[246px]':' right-0'}`}>
        ...
        <div className={`relative z-[2] h-fit pb-[59px] top-[40px] overflow-x-hidden shadow-[0px_0px_4px_rgba(0,0,0,0.5)] rounded-[12px_0px_0px_12px] bg-white box-border`}>
          {/* 미리보기 & 저장하기 */}
          ...
          <section className='rightmenu_li'>
            ...
            {isFontOption && <select className='block w-[188px] h-[29px] mt-3 mx-auto shadow-[inset_0px_0px_1px_1px_rgba(0,0,0,0.15)] rounded px-2'>
          ...
          {isOption &&
            <div>
              <button onClick={handleAddTable} type='button' className='group hover:shadow-[0px_0px_4px_rgba(0,0,0,0.25)] hover:text-[#00A3FF] rounded flex mx-3 items-center w-[198px] h-[39px]'>
                <RxPlus />
                <div className='group-hover:text-[#00A3FF] ml-2 text-sm leading-[22px] font-normal not-italic text-[#747474]'>상세 기능표 추가</div>
              </button>
                  <button type='button' className='w-[198px] h-[39px] group hover:shadow-[0px_0px_4px_rgba(0,0,0,0.25)] hover:text-[#00A3FF] rounded flex mx-3 items-center'>
                  <RxPlus />
