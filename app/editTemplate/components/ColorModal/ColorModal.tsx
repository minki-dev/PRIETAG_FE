...
export default function ColorModal() {
	...
	return (
		<form
			className="fixed left-0 top-0 z-30 flex h-full w-full flex-row items-center justify-center bg-black bg-opacity-50"
			onSubmit={() => submitColorHandler(submitColor)}
		>
			<dialog
				open={configState.isColorModalOpen}
				className="h-priceModal w-priceModal rounded-2xl border border-gray-200 bg-white p-8"
			>
