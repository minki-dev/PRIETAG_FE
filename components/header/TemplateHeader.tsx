		...
		<div className="relative">
			<div className="shadow-[0_1px_3px_rgba(0, 0, 0, 0.15)] fixed top-0 z-20 h-[72px] w-full bg-[#FFF] shadow-md">
				...
				<input
					...
					className="color-[#747474] absolute left-[180px] top-[calc(50%-26px/2)] flex h-[26px] w-[260px] items-center justify-center text-base font-normal leading-[26px] focus:outline-none"
				/>{' '}
				<RxHamburgerMenu
