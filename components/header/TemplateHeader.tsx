...
export default function TemplateHeader() {
	...
	return (
		<div className="relative">
			<div className="shadow-[0_1px_3px_rgba(0, 0, 0, 0.15)] absolute top-0 h-[72px] w-full bg-[#FFF]">
				<Image
					src="/ezfee.svg"
					alt="dd"
					width={93.81}
				...
				<input
					...
					className="color-[#747474] absolute left-[180px] top-[calc(50%-26px/2)] flex h-[26px] w-[210px] items-center justify-center text-base font-normal leading-[26px]"
				/>{' '}
				<RxHamburgerMenu
			...
			{isClicked ? (
				<nav className="absolute right-[40px] top-[45px] z-20 h-[160px] w-[200px] rounded-xl bg-white text-base  font-normal leading-[26px] text-black shadow-[0_0_4px_rgba(0,0,0,0.5)] shadow-[#D9D9D9] ">
					<ul>
